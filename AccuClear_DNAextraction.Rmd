---
title: "Standard Curve Accu Clear DNA extraction"
...
metadata <- read_excel("AccuClearQuantificationAssay.xlsx", 
    sheet = "Layout")
...
# Read data
data_raw_blanked <- read_excel("27.10.22_results_DNA_measurement.xlsx", range = "B50:O66") %>% 
  rename(Row=`...1`) %>% 
  rename(Reading=`...14`) %>% 
...
standards.lm.graph
ggsave("standard_linear_regression.png", width = 7, height = 3) 
