...
### Figure 7 | Statistical Analysis: For each strain we plot the Abundance over treatment. We apply the Wicoxon-rank sum test in order to compare 2 non-parametic groups. 
...
fig7 <- plot_grid(F201 + labs(colour=""),
                F247 + labs(colour=""),
                F112 + labs(colour=""),
                F004 + labs(colour=""),
                F125 + labs(colour=""),
...
fig7
#ggsave("fig7.3.png", height=7, width=10)
